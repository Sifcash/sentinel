...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to sifcashd "gobject list" output
    ...
    def sifcashd_serialise(self):
        import sifcashlib
        return sifcashlib.SHIM_serialise_for_sifcashd(self.serialise())
